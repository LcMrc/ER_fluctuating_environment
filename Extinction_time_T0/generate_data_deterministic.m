...
for i = length(tau) : -1 : 1
    ...
    T0list(i, :) = Gillespie_deterministic(bF, dF, bH, dH, K, N0, tau(i), Nit);
...
save T0_vs_tau_deterministic.mat

% Plot the data

fig = figure('Name','Extinction time - Deterministic environmental fluctuations','NumberTitle','off');
hold on  
